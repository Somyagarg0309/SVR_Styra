...
const ImageSlider = ({imageList}: Props) => {
    ...
    const firstVisibleItem = viewableItems?.[0]; // optional chaining
    if (firstVisibleItem?.index !== undefined && firstVisibleItem?.index !== null) {
      setPaginationIndex(firstVisibleItem.index % imageList.length);
    }
    }
