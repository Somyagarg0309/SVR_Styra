...
const WelcomeScreen = (props: Props) => {
  return (
    ...
    <View style={styles.container}>
      ...
      <Animated.Text style={styles.title} entering={FadeInRight.delay(300).duration(300).springify()}>Styra</Animated.Text>
      <Animated.Text style={styles.description} entering={FadeInRight.delay(500).duration(300).springify()}>Style yourself smart with AI.</Animated.Text>
      {/* button view */}
